...
def create_design_strategy(llm: LLM) -> Agent:
    return Agent(
        role="Design Lead",
        goal=(
        ...
        backstory=(
            "You are Design Strategy. You are calm, strategic, and direct. "
            ...
            "'Research & Insights — work with the available evidence on this topic. State your assumptions. "
