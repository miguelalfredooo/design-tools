...
import { Layers, Plus, Bird, Sun, Moon, Lock, Unlock, FlaskConical, Brain, Zap, PanelLeftClose, PanelLeft } from "lucide-react";
...
export function DesignSidebar() {
  ...
  const navItems = [
    ...
    { href: "/flow", icon: Zap, label: "Flow", active: isFlow },
  ];
