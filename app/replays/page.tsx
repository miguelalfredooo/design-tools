...
export default function ReplaysPage() {
  ...
  async function handleSynthesize() {
    ...
    try {
      ...
      // After storing, fetch the latest replay batch
  ...
  return (
    <div className="flex justify-center min-w-0 pt-6 pb-12 px-4">
      <div className="w-full max-w-[1280px] min-w-0">
        <div className="flex gap-6 items-start justify-center">
          {/* ── Left Column: Synthesis Snapshot ──────────────────── */}
            ...
            <div className="space-y-3">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Annotated Mixpanel recordings with friction analysis and
                  recommendations.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-border bg-card p-5">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    {
                      value: synthesis.sessionsReviewed,
                      label: "Sessions",
                      color: "text-foreground",
                    },
                    {
                      value: synthesis.totalFriction,
                      label: "Friction",
                      color: "text-amber-500 dark:text-amber-400",
                    },
                    {
                      value: synthesis.criticalIssues,
                      label: "Critical",
                    ...
                    <div key={stat.label} className="text-center">
                      <p
                        className={`text-3xl font-black tabular-nums leading-none ${stat.color}`}
                      >
                        {stat.value}
                      </p>
                ...
                {synthesis.themes.map((theme) => (
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <div
                        className={`size-7 rounded-lg ${theme.color} flex items-center justify-center`}
                      >
          ...
          {/* ── Right Column: Synthesis + Replay Cards ──────────── */}
          <div className="w-[600px] min-w-0 space-y-6">
            {/* ── Cross-Replay Synthesis Section ── */}
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-semibold">
                    Cross-Replay Insights
                  </h3>
                  <p className="text-xs text-muted-foreground">
                    AI-synthesized patterns across all session replays
                  </p>
                </div>
                <Button
                  size="sm"
              ...
              {synth && (
                <div className="space-y-4">
                  {/* Key Takeaway + Friction Chart side by side */}
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          {(
                            ...
                            const items = synth.matrix.filter(
                              (m) => m.quadrant === q
                            );
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground space-y-0.5">
                      <p>
                        ...
                        {replay.userContext.userType}
                      </p>
                      <p>
                        <span className="text-foreground font-medium">
                          Device:
                        </span>{" "}
                        {replay.userContext.device}
                      </p>
                      <p>
                        <span className="text-foreground font-medium">
                          Entry:
                        </span>{" "}
                        {replay.userContext.entryPoint}
                      </p>
                    </div>
                  </div>
